...
| Aggregate aliases `mean`, `median`, and `distinct_count` normalize to executable aggregate functions | `pkg/spl2/parser.go`, `pkg/spl2/parser_test.go`, `pkg/api/rest/server_test.go` |
