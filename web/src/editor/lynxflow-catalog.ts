...
export const COMMAND_DOCS: Record<string, string> = {
  ...
  mvexpand: "expand multivalue field",
  expand: "expand array values",
  makeresults: "generate test rows",
  makemv: "split multivalue field",
  mvcombine: "combine rows into multivalue",
  nomv: "join multivalue field",
  ...
  proportion: "matching event ratio",
  impact: "contribution by group",
  baseline: "rolling baseline",
  changes: "changed values",
  exemplars: "representative rows",
...
export const QUERY_TEMPLATES: readonly Completion[] = [
  ...
  { label: "proportion status>=500 AS error_rate by service", apply: "proportion status>=500 AS error_rate by service", type: "text", detail: "shortcut" },
  { label: "impact by service", apply: "impact by service", type: "text", detail: "shortcut" },
  { label: "baseline error_rate window=12 by service", apply: "baseline error_rate window=12 by service", type: "text", detail: "shortcut" },
  { label: "changes version by service", apply: "changes version by service", type: "text", detail: "shortcut" },
  { label: "exemplars 3 by service", apply: "exemplars 3 by service", type: "text", detail: "shortcut" },
