...
export const COMMAND_DOCS: Record<string, string> = {
  ...
  chart: "chart-style aggregate",
  rex: "regex extraction",
  regex: "regex filter",
  replace: "replace field values",
  fieldformat: "format display values",
  ...
  appendcols: "append subsearch columns",
  ...
  addinfo: "requires search metadata capability",
  convert: "requires conversion capability",
  fieldsummary: "requires field profiling capability",
  flatten: "requires object flattening capability",
  iplocation: "requires geoip capability",
  tags: "requires tags capability",
  typer: "requires field typing capability",
  thru: "requires pass-through capability",
  timewrap: "requires time comparison capability",
  tstats: "requires accelerated stats capability",
  mstats: "requires metrics stats capability",
  let: "eval alias",
  keep: "fields + alias",
  omit: "fields - alias",
